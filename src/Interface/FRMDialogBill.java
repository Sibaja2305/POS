...
public class FRMDialogBill extends javax.swing.JDialog {
     ...
     * @param status the label displaying the status
     * @param jpBackgroundTable the panel containing the table
     */
     ...
     * to cancel the bill.
     *
     * @param evt this section of code will be triggered when an action is
     * performed on the "jcPaymentMethod" object (when an item is selected from
     * the dropdown list).
     */
    ...
    /**
     * This method is executed when a key is released in the "txtCash"
     * component. Calculates and displays the corresponding change when entering
     * an amount of cash.
     *
     * @param evt The keyboard event that triggered this action.
     *
     *
     */
