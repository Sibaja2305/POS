...
public class JIFInventory extends javax.swing.JInternalFrame {
    ...
    /**
     * This button creates an instance of the FRMDialogAddInventory class,
     * places it in the center of the screen, and makes it visible.
     *
    ...
    private void btnAddInventoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddInventoryActionPerformed
        ...
        FRMDialogAddInventory dialogAddInventory = new FRMDialogAddInventory(null, true);

        dialogAddInventory.setLocationRelativeTo(null);
        // Set the dialog as modal and make it visible
        dialogAddInventory.setVisible(true);
    ...
    /**
     * This button loads the inventory list with the readInventory method that
     * contains logic and loads it to the jtInventory table.
     *
     * @param evt The action event generated by update inventory.
     */
    ...
    /**
     * This button deletes an inventory item in the jtInventory table with the
     * deleteTabaleInventory method containing logic. Also load the list back to
     * the jtInventory table with the loadInventoryTable method and save this
     * new list
     *
     * @param evt The action event generated by delete inventory.
     */
